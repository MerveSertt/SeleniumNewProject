...
public class C01_WebElementLocators {
    public static void main(String[] args) {
       ...
       driver.findElement(By.id("twotabsearchtextbox")).sendKeys("iphone" + Keys.ENTER);
        ...
        /*
        Bir web elementin locate'ini birden fazla kullanacaksanız bir webelement'e değişken olarak atayabilirsiniz.
        Webelement aramaKutusu = driver.findElement(By.id("twotabsearchtextbox"));  şeklinde kullanailiriz.
